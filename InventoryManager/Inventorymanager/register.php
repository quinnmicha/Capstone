...
<div class="container">
    ...
    <div class="row align-items-center">
        ...
        <form class="form-horizontal" action="manager_home.php" method="post">
            ...
            <div class="form-group">
                <label class="control-label col-sm-offset-1 col-sm-2" for="password">Confirm Password:</label>
                <div class="col-sm-6">          
                    <input type="text" class="form-control" id="confirm_password" placeholder="Confirm Password" name="confirm_password" required>
                </div>
            </div>
            <div class="form-group">        
